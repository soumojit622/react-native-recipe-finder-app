...
const SearchScreen = () => {
  ...
  if (initialLoading)
    return <LoadingSpinner message="Fetching delicious recipes..." />;
      ...
      <View style={searchStyles.resultsSection}>
        ...
        {loading ? (
          <View style={searchStyles.loadingContainer}>
            <LoadingSpinner message="Cooking up results..." size="small" />
          </View>
        ) : (
          <FlatList
            data={recipes}
  ...
  return (
    <View style={searchStyles.emptyState}>
      ...
      <Text style={searchStyles.emptyDescription}>
        Try adjusting your keywords or searching for an ingredient.
      </Text>
    </View>
  );
}
